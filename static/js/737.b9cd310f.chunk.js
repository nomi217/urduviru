...
`,R=C.default.div`
  ...
  margin-top: 10px;
  margin-bottom: 30px;
`;var A=n(70579);v().setAppElement("#root");const S=i.memo((e=>{let{modalTitle:t,children:n,onConfirm:i,...o}=e;const{t:r}=(0,s.B)();return(0,A.jsx)(v(),{...o,style:{content:{height:"281px",maxWidth:"348px",margin:"auto",borderRadius:"10px",border:"none"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.5)"}},children:(0,A.jsxs)(k,{className:"ModalBody",children:[(0,A.jsx)(w,{children:t}),(0,A.jsx)(R,{children:n}),(0,A.jsx)(y.A,{onClick:i,dark:!0,children:r("recordingsIntroduction:retryButton","Retry")})]})})}));const N=n.p+"static/media/start.9f864f38972bb654ed0bdf63209257e0.svg";var T=n(46716),E=n(68212);const j=C.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,z={usingMediaRecorder:!1,sampleRate:48e3,manualEncoderId:"wav",processorBufferSize:2048},G=e=>{let{className:t="",maxTimeInSeconds:n=30,onNewRecord:o,delay:r=500,recordingFile:a}=e;const{t:c}=(0,s.B)(),d=i.useRef(),l=i.useRef(0),h=i.useRef(),p=i.useRef(),m=i.useRef(),[b,v]=i.useState(!0),[y,C]=i.useState(),[k,w]=i.useState(!1),[R,E]=i.useState(!1),[F,G]=i.useState(!1),W=i.useCallback((e=>{l.current+=1;const{inputBuffer:t,outputBuffer:n}=e.detail;for(let i=0;i<n.numberOfChannels;i+=1){const e=t.getChannelData(i),o=n.getChannelData(i);for(let n=0;n<t.length;n+=1)o[n]=e[n]}}),[]),O=i.useCallback((async e=>{const{detail:t}=e,{recording:n}=t,i=await fetch(n.blobUrl).then((e=>e.blob())),r=`Filename.${z.manualEncoderId}`,s=g.A.blobToFile(i,r),a=g.A.sizeAsHuman(s.size,!0);o(s,a)}),[o]);i.useEffect((()=>{d.current=new f({...z,onRecording:O,onAudioProcesss:W});const e={audio:{echoCancellation:d.current.config.enableEchoCancellation}};if(navigator.mediaDevices.getUserMedia(e).then((()=>{v(!0)})).catch((()=>{v(!1)})),a){const e=a;if(e.size){const t=new Audio(URL.createObjectURL(e));t.load();const n=async()=>{t.removeEventListener("loadedmetadata",n),(0,x.D)(t,!0).then((e=>{var t;null===(t=h.current)||void 0===t||t.setTime(1e3*e)}))};t.addEventListener("loadedmetadata",n)}}return()=>{d.current&&d.current.cleanup()}}),[]);const V=i.useCallback((()=>{d.current&&(l.current=0,d.current.startRecording().then((()=>{var e;(C(!0),E(!1),h.current)&&(h.current.reset(),null===(e=h.current)||void 0===e||e.setTime(0),h.current.start())})).catch((e=>console.error("ERROR",e))))}),[]),H=i.useCallback((()=>{d.current&&(d.current.stopRecording(),C(!1),h.current&&(h.current.getTime()/1e3<2&&E(!0),h.current.stop()))}),[]),Z=i.useCallback((e=>e<10?`0${e}`:e),[]),Y=e=>{"touches"in e||e.preventDefault()},q=i.useCallback((e=>{e.target&&(e.target.addEventListener("touchend",Y,{passive:!1}),m.current=e.target),p.current=setTimeout((()=>{w(!0),G(!0),E(!1)}),r)}),[r]),K=i.useCallback((()=>{p.current&&clearTimeout(p.current),F&&w(!1),G(!1),m.current&&m.current.removeEventListener("touchend",Y)}),[F]);return(0,A.jsxs)(j,{className:t,children:[(0,A.jsxs)(L,{children:[!R&&(0,A.jsx)(P,{show:k,children:c(y?"recordingsIntroduction:releaseButtonStop":"recordingsIntroduction:releaseButtonStart")}),(0,A.jsx)(S,{isOpen:R,modalTitle:"Oops.",onConfirm:V,children:c("recordingsIntroduction:shortRecording")})]}),(0,A.jsx)(_,{children:(0,A.jsxs)(u(),{ref:h,startImmediately:!1,checkpoints:[{time:1e3*n,callback:H}],children:[(0,A.jsx)(u().Minutes,{}),":",(0,A.jsx)(u().Seconds,{formatValue:Z})]})}),(0,A.jsxs)(M,{children:[(0,A.jsxs)(U,{children:[(0,A.jsx)(D,{disabled:!b||y,onClick:V,onMouseDown:q,onMouseUp:K,onTouchStart:q,onTouchEnd:K,onMouseLeave:K,children:(0,A.jsx)(I,{src:N,alt:"Start"})}),(0,A.jsx)(B,{children:c("recordingsIntroduction:recordCough.record")})]}),(0,A.jsxs)(U,{children:[(0,A.jsx)(D,{disabled:!b||!y,onClick:H,onMouseDown:q,onMouseUp:K,onTouchStart:q,onTouchEnd:K,onMouseLeave:K,children:(0,A.jsx)($,{src:T.A,alt:"Stop"})}),(0,A.jsx)(B,{children:c("recordingsIntroduction:recordCough.stop")})]})]})]})},W=i.memo(G);var O=n(66986);const V=n.p+"static/media/upload.9158ee0e5481659aabd3b47572c2618e.svg";var H=n(21805);const Z=d.Ik({recordingFile:d.gl().required("ERROR.FILE_REQUIRED").test("fileSize","ERROR.FILE_SIZE",(e=>{if(e){const t=e,{size:n}=t;return n<=1024**3*5}return!!e})).test("fileDuration","ERROR.FILE_DURATION",(async e=>{if(e){const t=e,n=new Audio(URL.createObjectURL(t));n.load(),await new Promise((e=>n.addEventListener("loadedmetadata",e)));return await new Promise((e=>{n.duration!==1/0&&e(n.duration),n.addEventListener("durationchange",(()=>{n.remove(),e(n.duration)})),n.volume=0,n.currentTime=86400,n.play()}))>=2}return!!e}))}).defined(),Y=e=>{let{onNext:t,onManualUpload:n,defaultValues:o,currentLogic:d,action:l}=e;const{Portal:u}=r()({bindTo:document&&document.getElementById("wizard-buttons")}),{handleSubmit:h,control:p,getValues:m,formState:f}=(0,a.mN)({mode:"onChange",defaultValues:o,resolver:(0,c.t)(Z)}),{t:g}=(0,s.B)(),{isValid:x}=f,b=i.useRef(1);return(0,A.jsx)(A.Fragment,{children:(0,A.jsxs)(H.MainContainer,{children:[(0,A.jsx)(H.MicContainer,{children:(0,A.jsx)(a.xI,{control:p,name:"recordingFile",render:e=>{let{onChange:t}=e;return(0,A.jsx)(W,{onNewRecord:t,recordingFile:null===o||void 0===o?void 0:o.recordingFile},b.current)}})}),(0,A.jsxs)(u,{children:[(0,A.jsx)(O.A,{invert:!0,leftLabel:g("recordingsRecord:next"),leftDisabled:!x,leftHandler:h(t)}),(0,A.jsxs)(H.UploadContainer,{onClick:()=>{l({[d]:{recordingFile:m("recordingFile")||null,uploadedFile:null}}),null===n||void 0===n||n()},children:[(0,A.jsx)(H.UploadImage,{src:V}),(0,A.jsx)(H.UploadText,{children:g("recordingsRecord:upload")})]})]})]})})},q=i.memo(Y)},21805:(e,t,n)=>{n.r(t),n.d(t,{MainContainer:()=>a,MicContainer:()=>d,StopImg:()=>p,Text:()=>c,UploadContainer:()=>l,UploadImage:()=>u,UploadText:()=>h});var i=n(30009),o=n(94748),r=n(68212),s=n(46716);const a=i.default.div`
  padding: 0px 0px;
`,c=(0,i.default)(o.L_)`
...
`,p=i.default.img.attrs((()=>({src:s.A})))`
  ...
  height: 10px;
  margin: 0px 2px 4px;
`},27249:(e,t,n)=>{n.d(t,{A:()=>i});const i={sizeAsHuman:(e,t)=>{const n=t?1e3:1024;if(Math.abs(e)<n)return`${e} B`;const i=t?["kB","MB","GB","TB","PB","EB","ZB","YB"]:["KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"];let o=-1;do{e/=n,++o}while(Math.abs(e)>=n&&o<i.length-1);return`${e.toFixed(1)} ${i[o]}`},blobToFile:(e,t)=>{const n=e;return n.lastModifiedDate=new Date,n.name=t,e}}},46716:(e,t,n)=>{n.d(t,{A:()=>i});n(65043);const i=n.p+"static/media/stop.d8f5b556448dfb3911a7cae0258e02fb.svg"},66986:(e,t,n)=>{n.d(t,{A:()=>c});var i=n(65043),o=n(88016);const r=n(30009).default.div`
  display: flex;
  align-items: center;
  justify-content: center;
...
//# sourceMappingURL=737.b9cd310f.chunk.js.map